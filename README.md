...
## How to cite 
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Select Best Partition with Macro-F1 and ECC}, year = {2021}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/Best-Partition-MaF1-ECC}}}
...
## RUN
To run the code, open the terminal, enter the *~/Best-Partition-MaF1-ECC/R* folder, and type
...
```
Rscript macrof1.R "~/Best-Partition-MaF1-ECC/bpma-ecc-Config-Files/jaccard/j-bpma-GpositiveGO.csv"
```
