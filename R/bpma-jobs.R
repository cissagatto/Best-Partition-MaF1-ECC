...
###############################################################################
# Exhaustive Partitions Macro-F1 with Ensemble of Classifier Chain            #
# Copyright (C) 2022                                                          #
#                                                                             #
...
###############################################################################
FolderJob = paste(FolderRoot, "/bpma-ecc-jobs", sep = "")
...
while(f<=length(similarity)){
  ...
  while(i <= n) {
    ...
    # Confi File Name
    config_name = paste(FolderS2, "/", sim[f], "-e-bpma-",
    ...
    str7 = paste("Rscript /home/u704616/Best-Partition-MaF1-ECC/R/macrof1.R \"",
                 config_name, "\"", sep = "")
